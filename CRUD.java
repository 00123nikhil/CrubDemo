...
public class CRUD {
	...
	public static void main(String[] args) {
		CRUD objTest = new CRUD();
	      objTest.create("1", "nikhil", "1999-04-13", "2021-12-1");
		  objTest.create("2", "kedar", "1999-09-28", "2021-11-1");
		  objTest.create("3", "kamraj", "1999-03-25", "2021-10-1");
		  objTest.read("1");
		  objTest.update("3", "3", "atul", "1999-5-22","2021-9-1");
